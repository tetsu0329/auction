...
public class BidList2 {
    ...
    public BidList2(String bidID, String userID, String bidName, String bidPrice, String winningBid, String bidDays, String bidType, String bidImage1, String bidImage2, String condition, String biddersNote, String quantity) {
        this.bidID = bidID;
        this.userID = userID;
