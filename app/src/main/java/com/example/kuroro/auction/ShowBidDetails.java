        ...
        mDatabaseRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.hasChild("bidImage3")){
                    ...
                    Query search = mDatabaseRef.orderByChild("bidID").equalTo(bidID);
                    search.addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                BidList bidList3 = snapshot.getValue(BidList.class);
                                try {
                                    ...
                                    Picasso.with(getActivity()).load(bidList3.getBidImage1()).into(imageView2);
                                    Picasso.with(getActivity()).load(bidList3.getBidImage1()).into(imageView3);
                    ...
                    search.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                ...
                                try {
                                    textView.setText(bidList3.getBidName());
                                    textView2.setText(bidList3.getWinningBid());
                                    Picasso.with(getActivity()).load(bidList3.getBidImage1()).into(imageView);
                                    Picasso.with(getActivity()).load(bidList3.getBidImage1()).into(imageView2);
